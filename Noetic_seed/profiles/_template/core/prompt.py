...
1. [意図・目的] → ツール名（または ツール名+ツール名+...） / predicted_e2: XX / predicted_ec: 0.XX
2. [意図・目的] → ツール名（または ツール名+ツール名+...） / predicted_e2: XX / predicted_ec: 0.XX
3. [意図・目的] → ツール名（または ツール名+ツール名+...） / predicted_e2: XX / predicted_ec: 0.XX
4. [意図・目的] → ツール名（または ツール名+ツール名+...） / predicted_e2: XX / predicted_ec: 0.XX
5. [意図・目的] → ツール名（または ツール名+ツール名+...） / predicted_e2: XX / predicted_ec: 0.XX
