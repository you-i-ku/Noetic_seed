...
TOOLS = {
    ...
    "output_display":    {"desc": "相手に言葉を届ける。device/claude など直接対話チャネル向け。[X_input] で話しかけてきた相手には同じ channel で返す。Elyth/X 等の SNS 投稿とは別経路。引数: content=メッセージ [channel=送信先チャネル id、省略時は device]", "func": _output_display},
