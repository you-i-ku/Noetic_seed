...
TOOLS = {
    ...
    "output_display":    {"desc": "発話を channel 指定で届ける。送信先 channel は WM.channels を観察して決定、受信 channel に対応させて返す。Elyth/X 等の SNS 投稿とは別経路。引数: content=メッセージ channel=送信先 channel id (必須)", "func": _output_display},
